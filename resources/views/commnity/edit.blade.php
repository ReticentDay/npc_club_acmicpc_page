        ...
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" id="newsFrom" action="/community/{{ $communityTable->id }}" method="post">
                        {!! csrf_field() !!}
                        ...
                        <div id="titleRow" class="row">
                            ...
                            <div class="col-md-10 col-sm-8 col-xs-12">
                                <input type="text" id="titleInput" class="form-control" name="title" value="{{ $communityTable->title }}" placeholder="title">
                            </div>
                        </div>
                        <div id="titleRow" class="row">
                            <div class="col-md-2 col-sm-4 col-xs-12">
                        ...
                        <div id="titleRow" class="row">
                            ...
                            <div class="col-md-10 col-sm-8 col-xs-12">
                                <input type="text" id="titleInput" class="form-control" name="association" value="{{ $communityTable->association }}" placeholder="association">
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $('#typeSelect').val('{{ $communityTable->type }}');
        ...
        $('#summernote').summernote('code','{!! $communityTable->content !!}');
